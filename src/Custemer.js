...
const orang = require('./img/vv.png');
class CustemerScreen extends React.Component {
  ...
  _onRefresh() {
    ...
    fetch('http://mhs.rey1024.com/appmobile/D1615051080/getData.php')
  ...
  return fetch('http://mhs.rey1024.com/appmobile/D1615051080/getData.php')
    .then((response) => response.json())
    .then((responseJson) => {
      let ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});
      this.setState({
    ...
    return (
      <TouchableOpacity activeOpacity={0.7} style={styles.row}>
         ...
         <View style={styles.tulisan}>
          ...
          <Text style={styles.Details}>alamat : {record.alamat}</Text>
          
          <Text style={styles.Details}>nomor : {record.nomor}</Text>
          </View>
         </View>
		...
		return(
			<ImageBackground
              ...
              <View style={styles.box}>
        			<Text style={styles.title}>DATA NAMA PENUMPANG</Text>
